...
try {
    ...
    if ($stmt && $stmt->execute()) {
        ...
        // Se for uma instalação com status 'Aguardando etiqueta', cria a ocorrência de processamento
        if ($tipo_manutencao === 'instalação' && $status_reparo === 'Aguardando etiqueta') {
