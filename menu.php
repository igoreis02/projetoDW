                ...
                <div class="menu-buttons-container">
                    <div class="menu-row">
                        <a href="manutencoes_instalacoes.php" class="menu-button" id="manutencao"><i
                                class="fas fa-tools"></i><span>Adicionar</span><span>Serviços e Instalações</span></a>
                        <a href="ocorrenciasPendentes.php" class="menu-button" id="manutencaoPendentes"><i
                                class="fas fa-clock"></i><span>Atribuir Técnico </span><span>Serviços Pendentes</span></a>
                    ...
                    <div class="menu-row">
                        <a href="ocorrenciasEmAndamento.php" class="menu-button" id="manutencaoAndamento"><i
                                class="fas fa-cogs"></i><span>Serviços Em Andamento</span></a>
