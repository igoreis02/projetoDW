<?php
// Adicionado para depuração temporária. REMOVA EM PRODUÇÃO!
...
// Logs para depuração - Verifique o arquivo de log de erros do seu PHP!
error_log("Raw input (atribuir_tecnicos_manutencao.php): " . $input);
error_log("Decoded data (atribuir_tecnicos_manutencao.php): " . print_r($data, true));
